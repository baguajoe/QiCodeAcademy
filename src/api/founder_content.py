...
This text is VERBATIM from the organization (current version). Do not add, change,
or embellish credentials, lineage names, titles, or dates. The frontend keeps an
identical fallback in src/front/js/founderContent.js (checked by tests/test_founder.py).
...
FOUNDER_CREDENTIALS = "\n".join([
    ...
    "Massage Therapy Diploma (10 months, 650 hours) — New England School of Therapeutics, 2021",
    ...
    "Founder, Eye Forge Studios LLC",
    "BS, Bowling Green State University, 1996"
])

# SHA-256 fingerprints of every earlier seeded version (old wording is intentionally
...
LEGACY_FINGERPRINTS = {
    "short_bio": {"91e0cc44807ae06a7ecaa93142c14691c9e80ad9d2e13486a928466c038ff8c8", "b66c5e708f4e688feef3c354155c2cfc9963655422b9f240cb0cfde799154efb"},
    "full_bio": {"c9d2739d2dd066b15d1b2814d090d3a0b91ed100efc7c4f6d149e8dee9fe1bc7", "ffff90530286ba429709f637bc41f6e661fb3eae187ef960fdf105e20122535b"},
    "credentials": {"37030d5f4243e3a398d55a13aecb9635d9182665c6c40b287569fab845faed2d", "fd7a52f3c5cb4356cbdd7a6b9577e34fe772a3cc54a8a34482f387f03a26b182"},
}
